...
\emph{Simscene} tient compte de cette distinction, et utilise deux banques de données : l'une regroupant classes d’événements, l'autre des classes de textures. Événements et textures bénéficient de processus de simulation particuliers.
...
L'outil de simulation n'autorise pas d’interagir avec un sample en particulier, mais toujours avec une piste, \ie~une séquence de samples. Plusieurs paramètres permettent au sujet de contrôler la structure de chaque piste. 
