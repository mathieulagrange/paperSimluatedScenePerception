...
%DIF ADD lafaySimulatedScenePerception.tex      Tue Sep  4 11:07:27 2018
\usepackage{url}
...
\cite{Salamon14}}%DIFAUXCMD
, see Appendix~\ref{app:taxonomie}}\DIFaddend . Only three levels of abstraction are considered for the texture sounds\DIFaddbegin \DIFadd{, see Figure~\ref{fig:taxonomieT}}\DIFaddend .
...
\DIFdelend \DIFaddbegin \DIFadd{online}\footnote{\DIFadd{Available online }\url{http://soundthings.org/research/urbanSoundScape/XP2014}}\DIFaddend .
...
\begin{figure}[h]
        ...
        \caption{Distribution of scores given by the subjects during experiment 2 for \DIFdelbeginFL \DIFdelFL{i/am-scenes }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the ideal scenes with markers }\DIFaddendFL (green) et \DIFdelbeginFL \DIFdelFL{ni/am-scenes }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{non-ideal scenes with markers }\DIFaddendFL (red). The horizontal axis is, from left to right, the 11-point bipolar semantic scale ranging from -5 (non-ideal / very unpleasant) to +5 (ideal / very pleasant).}\label{fig:xp4_note_1}
\end{figure}
